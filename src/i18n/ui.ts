...
export const ui = {
  fr: {
    ...
    'search.fulltext': 'Résultats plein texte',
    'search.empty.title': 'Aucun terme ne correspond',
    'search.empty.body': 'Essayez un autre mot-clé ou réinitialisez les filtres.',
    'search.reset': 'Réinitialiser les filtres',
    'az.label': 'Index alphabétique',
  ...
  en: {
    ...
    'search.fulltext': 'Full-text results',
    'search.empty.title': 'No term matches',
    'search.empty.body': 'Try another keyword or reset the filters.',
    'search.reset': 'Reset filters',
    'az.label': 'Alphabetical index',
